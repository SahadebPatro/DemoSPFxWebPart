...
export function PaymentComponent(props: IPaymentProps) {

    const { userData, userEmail, country } = props;
    ...
    const CalculateTotalCost = (): number => {
        let total = 0;
        userData.map(item => (total += item.TotalCost));
        return total;
    };
            ...
            {isOrdered ?
                ...
                <div className="payment-info">
                    <div className="d-flex justify-content-between align-items-center">
                        ...
                        <img className="rounded" src={`/_layouts/15/userphoto.aspx?size=L&username=${userEmail}`} width="30" />
                    </div>
